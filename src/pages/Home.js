...
<div className=''>
<Link to={`${review.user_username}/film/${review.movie}/${slugify(review.movieData.title)}`}  onClick={() => setReviewData(review)}><img src={review.movieData.poster_path?`${API_IMAGE}`+`${review.movieData.poster_path}`:noImage} alt="movie image" className="img-fluid img-5em-8em rounded-2 " /></Link>
        </div>
